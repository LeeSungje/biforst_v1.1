...
function ajaxShowMmeDetail(url){
  ...
  .done(function(data){
	...
	//fallback(1)
	//통계 임계치 설정 및 통계 출력
	var s_format_ATT= "<div class=\"col-sm-10 mme-stat-panel\">"+
	"<div id=\"ATTstat\" class=\"mme-stat-txt\">Attach 성공률 </div></div>";
	
    var s_format_SRMO= "<div class=\"col-sm-10 mme-stat-panel\">"+
    "<div id=\"SRMOstat\" class=\"mme-stat-txt\">SRMO 성공률 </div></div>";

    var s_format_SRMT= "<div class=\"col-sm-10 mme-stat-panel\">" + 
    "<div id=\"SRMTstat\" class=\"mme-stat-txt\">SRMT 성공률 </div></div>";

    var s_format_ESRMO= "<div class=\"col-sm-10 mme-stat-panel\">" + 
	"<div id=\"ESRMOstat\" class=\"mme-stat-txt\">ESRMO 성공률 </div></div>";
	
    var s_format_ESRMT= "<div class=\"col-sm-10 mme-stat-panel\">" + 
	"<div id=\"ESRMTstat\" class=\"mme-stat-txt\">ESRMT 성공률 </div></div>";
	
    var s_format_TAU= "<div class=\"col-sm-10 mme-stat-panel\">" + 
	"<div id=\"TAUstat\" class=\"mme-stat-txt\">TAU 성공률 </div></div>";
	
    var s_format_PAG= "<div class=\"col-sm-10 mme-stat-panel\">" + 
					...
					console.log("시스템명 : "+vendor[index]);
						switch(type[index]){
							...
							case "CS_SR_MT" : 
								...
								break;
							case "TAU" : 
								$(".stat-panel").append(s_format_TAU);
								...
								break;
							case "PAG" : 
								$(".stat-panel").append(s_format_PAG);
