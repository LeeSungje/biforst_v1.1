...
function ajaxShowSystemDetail(url){
  ...
  .done(function(data){
    ...
    $(".sgwList-container").find(".col-sm-2").remove(); 
    $(".sgwList-container").find(".col-sm-3").remove();   
    ...
    system_type.forEach(function(e,index){
		if(system_type[index] == 'L'){
		  ...
		  var format_html= "<div class=\"col-sm-3 sys-detail-container\">"+
		    ...
		    "<div id=\"system-name-L\" class=\"sys-detail-ttl\"></div>"+
		    "<span id=\"curSysSesContainerL\"></span>" +
		    "<span class=\"sys-detail-delimiter\">&nbsp/&nbsp</span>" + 
		    "<span id=\"totSysSesContainerL\"></span></div>";
		 
		  $(".legacy-sgw-panel").append(format_html); 
		  ...
		  var format_html= "<div class=\"col-sm-3 sys-detail-container\">"+
			"<div class=\"sys-detail-box align-middle\">"+
		    "<div id=\"system-name-V\" class=\"sys-detail-ttl\"></div>"+
		    "<span id=\"curSysSesContainerV\"></span>" +
		    "<span class=\"sys-detail-delimiter\">&nbsp/&nbsp</span>" + 
		    "<span id=\"totSysSesContainerV\"></span></div>";

		  $(".virtual-sgw-panel").append(format_html); 
		  ...
		  var format_html= "<div class=\"col-sm-3 sys-detail-container\">"+
		    ...
		    "<span id=\"curSysSesContainerS\"></span>" +
		    "<span class=\"sys-detail-delimiter\">&nbsp/&nbsp</span>" + 
		    "<span id=\"totSysSesContainerS\"></span></div>";
