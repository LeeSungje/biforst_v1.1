...
function ajaxShowSystemDetail(url){
  ...
  .done(function(data){
	...
	$(".mmeList-container").find(".col-sm-6").remove();
    ...
    system_type.forEach(function(e,index){
		if(system_type[index] == 'C'){
			...
			var format_html= "<div class=\"col-sm-6 \">"+
				    ...
				    "<div id=\"system-name-C\" class=\"sys-detail-name\"></div>"+
				    "<span id=\"curSysSubContainerC\"></span>" +
				    "<span class=\"sys-detail-delimiter\">&nbsp/&nbsp</span>" + 
				    "<span id=\"totSysSubContainerC\"></span></div>";
				  
			$(".center-mme-panel").append(format_html);
	      ...
	      $("#totSysSubContainerC"+system_name[index]).append(totSubAddHtml);
			...
			var format_html= "<div class=\"col-sm-6 \">"+
					"<div class=\"sys-detail-box align-middle\">"+
				    "<div id=\"system-name-E\" class=\"sys-detail-name\"></div>"+
				    "<span id=\"curSysSubContainerE\"></span>" +
				    "<span class=\"sys-detail-delimiter\">&nbsp/&nbsp</span>" + 
				    "<span id=\"totSysSubContainerE\"></span></div>";
				  
			$(".east-mme-panel").append(format_html);
	      ...
	      $("#totSysSubContainerE"+system_name[index]).append(totSubAddHtml);
			...
			var format_html= "<div class=\"col-sm-6 \">"+
					"<div class=\"sys-detail-box align-middle\">"+
				    "<div id=\"system-name-G\" class=\"sys-detail-name\"></div>"+
				    "<span id=\"curSysSubContainerG\"></span>" +
				    "<span class=\"sys-detail-delimiter\">&nbsp/&nbsp</span>" + 
				    "<span id=\"totSysSubContainerG\"></span></div>";
				  
			$(".ng-mme-panel").append(format_html);
